        ...
        <div class="wrapper wrapper_js">
            ...
            <div class="content content_js align_center">
                ...
                <div class="content_inner display-inline  content_big">
                    <img src="assets/images/image_3.png" class="image_2" width="150" alt="" />
                    <p class="color_azul"><strong>
                            No tienes <br />
                            Saldo suficiente <br />
                            para comprar esta promoción
                        </strong>
                    </p>
                    <div class="mensaje">
                        <div class="mensaje_inner">
                            <p>Te recomendamos recargar 
                                tu celular y revisar tu saldo 
                                marcando el *515# opción Consultas</p>
                        </div>
