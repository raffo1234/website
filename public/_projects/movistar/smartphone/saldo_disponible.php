    ...
    <body>
        <div class="wrapper wrapper_js">
            ...
            <div class="content content_js align_center">
                ...
                <div class="content_inner display-inline  content_big">
                    <img src="assets/images/image_2.png" class="image_2" width="150" alt="" />
                    <p class="color_azul"><strong>Todavía cuentas con <br />
                        MB para navegar <br />
                        por internet</strong></p>
                    <div class="mensaje">
                        <div class="mensaje_inner">
                            <p>En breves momentos recibirás un SMS.
                                Para consultar tu saldo de MB
                                marca el *515# opción Consultas</p>
                        </div>
